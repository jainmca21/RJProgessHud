...
@protocol RJProgressHUDDelegate;


typedef enum {
	/** Progress is shown using an UIActivityIndicatorView. This is the default. */
	RJProgressHUDModeIndeterminate,
	/** Progress is shown using a round, pie-chart like, progress view. */
	RJProgressHUDModeDeterminate,
	/** Progress is shown using a ring-shaped progress view. */
	RJProgressHUDModeAnnularDeterminate,
	/** Shows a custom view */
	RJProgressHUDModeCustomView,
	/** Shows only labels */
	RJProgressHUDModeText
} RJProgressHUDMode;

typedef enum {
	/** Opacity animation */
	RJProgressHUDAnimationFade,
	/** Opacity + scale animation */
	RJProgressHUDAnimationZoom,
	RJProgressHUDAnimationZoomOut = RJProgressHUDAnimationZoom,
	RJProgressHUDAnimationZoomIn
} RJProgressHUDAnimation;
...
typedef void (^RJProgressHUDCompletionBlock)();
#endif
 ...
 * The RJProgressHUD window spans over the entire space given to it by the initWithFrame constructor and catches all
 * user input on this region, thereby preventing the user operations on components below the view. The HUD itself is
 * drawn centered as a rounded semi-transparent view which resizes depending on the user specified content.
 *
 * This view supports four modes of operation:
 * - RJProgressHUDModeIndeterminate - shows a UIActivityIndicatorView
 * - RJProgressHUDModeDeterminate - shows a custom round progress indicator
 * - RJProgressHUDModeAnnularDeterminate - shows a custom annular progress indicator
 * - RJProgressHUDModeCustomView - shows an arbitrary, user specified view (@see customView)
 *
 ...
 *
 * @param view The view that is going to be searched.
 * @return All found HUD views (array of RJProgressHUD objects).
 */
 ...
 * @see showAnimated:whileExecutingBlock:onQueue:completion:
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block completionBlock:(RJProgressHUDCompletionBlock)completion;
 ...
 */
@property (atomic, copy) RJProgressHUDCompletionBlock completionBlock;

#endif

/** 
 * RJProgressHUD operation mode. The default is RJProgressHUDModeIndeterminate.
 *
 * @see RJProgressHUDMode
 */
@property (atomic, assign) RJProgressHUDMode mode;

/**
 * The animation type that should be used when the HUD is shown and hidden. 
 *
 * @see RJProgressHUDAnimation
 */
@property (atomic, assign) RJProgressHUDAnimation animationType;

/**
 * The UIView (e.g., a UIImageView) to be shown when the HUD is in RJProgressHUDModeCustomView.
 ...
 *
 * @see RJProgressHUDDelegate
 */
@property (atomic, MB_WEAK) id<RJProgressHUDDelegate> delegate;
...
@protocol RJProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(RJProgressHUD *)hud;
